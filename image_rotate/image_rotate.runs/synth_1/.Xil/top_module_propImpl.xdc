set_property SRC_FILE_INFO {cfile:{F:/VIVADO WORKSPACE/image_rotate/image_rotate.srcs/constrs_1/new/Arty-Z7-20-Master.xdc} rfile:../../../image_rotate.srcs/constrs_1/new/Arty-Z7-20-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports {uart_tx}]; # TX
set_property src_info {type:XDC file:1 line:189 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports {uart_rx}]; # RX
