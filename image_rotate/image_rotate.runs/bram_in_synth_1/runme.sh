...
HD_PWD='D:/VIVADO_workspace/image_rotate/image_rotate.runs/bram_in_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_in.tcl
