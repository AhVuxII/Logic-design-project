...
#
# Script generated by Vivado on Fri Nov 21 12:27:43 +0700 2025
...
#
# Usage        : bram_in.sh
#                bram_in.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_in.sh [-reset_run]
#                bram_in.sh [-reset_log]
#                bram_in.sh [-help]
#
...
# script info
echo -e "bram_in.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_in.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_in xil_defaultlib.bram_in xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_in -key {Behavioral:sim_1:Functional:bram_in} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_in.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_in.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_in.sh [-help]\n\
Usage: bram_in.sh [-step]\n\
Usage: bram_in.sh [-lib_map_path]\n\
Usage: bram_in.sh [-reset_run]\n\
Usage: bram_in.sh [-reset_log]\n\
Usage: bram_in.sh [-keep_index]\n\
Usage: bram_in.sh [-noclean_files]\n\n\
