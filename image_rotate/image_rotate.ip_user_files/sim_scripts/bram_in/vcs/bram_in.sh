...
#                script (type 'bram_in.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_in xil_defaultlib.glbl -o bram_in_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_in_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_in_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_in_simv.daidir vcs_lib c.obj)
